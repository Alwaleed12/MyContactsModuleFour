...
module.exports = {
    ...
    addContact: async function (fullname, phone, email) {
        ...
        // declare funstion that will create the group table
        createGroupsTable: async function() {
            ...
            (await myContactsDB).transaction(txn => {
                ...
                txn.executeSql(
                    ...
                    error => {
                        console.log('Error creating group table ' + error.message);
                    },
                );
            });
        },

         // declare function that will insert a row of data into the group table
